...
terraform {
  ...
  backend "azurerm" {
    resource_group_name   = "gopal-storage" #replace it with your storage account resource group name
    storage_account_name  = "terraformstoragegopal1" #replace it with your storage account name
